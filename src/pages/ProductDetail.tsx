...
import { ArrowLeft, ShoppingCart, MessageCircle, Star, Plus, Minus } from 'lucide-react';
...
const ProductDetail = () => {
  ...
  const featuredProducts = products.filter(p => p.featured && p.id !== id).slice(0, 4);
  ...
  const handleBuyNow = () => {
    ...
    const message = `🛍️ *New Order from 999 Shopping*\n\n${orderDetails}\n\n*Total Amount: Rs. ${totalAmount.toLocaleString()}*\n\nPlease confirm this order.`;

    const whatsappUrl = `https://wa.me/94760783098?text=${encodeURIComponent(message)}`;
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2 bg-muted rounded-lg">
                  ...
                  <span className="px-3 font-medium min-w-[3rem] text-center">{quantity}</span>
                  <Button
                    variant="ghost"
                    size="sm"
